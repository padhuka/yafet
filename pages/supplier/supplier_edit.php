...
<div class="modal-dialog">
   ...
   <table width="100%"><tr style="text-align: center;"><td width="90%" style="padding-left: 10%;">.::<?php echo $title;?>::.</td><td width="10%" align="right"><button type="button" data-dismiss="modal">x</button></td></tr></table>
                ...
                <tr role="row" class="odd">
                   <td class="sorting_1" width="15%">Kode Supplier</td>
                  <td width="30%"> <input type="text" class="form-control" id="id_supplier" name="id_supplier" value="<?php echo $emp['id_supplier'];?>" required readonly></td>
                  <td  width="20%"></td>
                  <td  width="50%">
                   </td>
                  </td>
               ...
               <tr role="row" class="even">
                ...
                <tr><td colspan="4">&nbsp;</td></tr>
                 <tr><td colspan="4" align="center" class="bgsave"><button type="submit" class=" btn btn-default btn-circle save_submit" name="Submit" value="SIMPAN">Simpan</button>
                                    ...
                                    <input type="hidden" name="id_supplierhid" id="id_supplierhid" value="<?php echo $emp['id_supplier'];?>">
