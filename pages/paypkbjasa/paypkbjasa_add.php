   ...
   <table width="100%"><tr style="text-align: center;"><td width="90%" style="padding-left: 10%;">.::<?php echo $title;?>::.</td><td width="10%" align="right"><button type="button" data-dismiss="modal">x</button></td></tr></table>
                ...
                <div class="modal-content" style="height: 240px;">
                    <div class="modal-header">                        
                        <h4 class="modal-title" id="myModalLabel">Tambah Data Payment PKB Jasa
</h4>
                    </div>
                  
                    <div class="modal-body">
                    <form class="form-horizontal" enctype="multipart/form-data" novalidate id="formpaypkbjasa">
...
<?php //include_once 'paypkbjasa_pkb_tab.php';?>
<?php include_once 'paypkbjasa_kwitansi_tab.php';?>
<?php //include_once 'paypkbjasa_partner_tab.php';?>
<script type="text/javascript">
  ...
  function selectKwi(){ 
    $("#ModalpaypkbjasaKwitansi").modal({backdrop: 'static',keyboard:false});   

  }
  function selectPkb(){ 
    $("#ModalpaypkbjasaPkb").modal({backdrop: 'static',keyboard:false});   
  }
  function selectPartner(){ 
    $("#ModalpaypkbjasaP").modal({backdrop: 'static',keyboard:false});   
  }

  $(document).ready(function (){

                      $("#formpaypkbjasa").on('submit', function(e){
                          var chs= $("#chasis").val();
                          var km=  $("#kmmasuk").val();
                          if (chs==''){
                          ...
                          e.preventDefault();
                            //alert(disposisine)                       ;
                                      $.ajax({
                                                  type: 'POST',
                                                  url: 'paypkbjasa/paypkbjasa_add_save.php',
