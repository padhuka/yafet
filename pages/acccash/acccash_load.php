      ...
      <form class="form-horizontal" enctype="multipart/form-data" novalidate id="formcashacc">
        <table width="40%" class="table table-condensed table-bordered table-striped table-hover DataTable">
          ...
          <tr valign="middle">
            ...
            <td width="35%">
              <table><tr><td><input type="text" class="form-control" id="idacccash" name="idacccash" readonly style="width: 95%"></td><td>
                                <button type="button" class="btn btn-default btn-circle btn-md" data-toggle="modal" data-target="#myModal" onclick="open_addcash();" id="buttonaddcash">Pilih</button></td></tr></table>
              </td>
           <td width="10%"></td>
...
<br>
        <table width="40%" class="table table-condensed table-bordered table-striped table-hover DataTable" id="reffacc">
          <tr valign="middle">
             <td width="15%"></td>
             <td width="35%"></td>
             <td width="10%"></td>
      ...
      <br><br>
      <table id="example1" class="table table-condensed table-bordered table-striped table-hover DataTable">
