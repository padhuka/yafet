     <div id="ModalAsuransi" class="modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"> <div class="modal-dialog">
      <div class="col-md-14">
                ...
                <?php
                        ...
                        <tr>
                          ...
                          <td>
                                     <button type="button" class="btn btn-default btn-circle" onclick="pilihAsuransi('<?php echo $catat['id_asuransi'];?>','<?php echo $catat['nama'];?>');">Pilih</button>
                          </td>
                        </tr>
                    <?php }?>                        
                </tfoot>
