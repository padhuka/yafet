   ...
   <table width="100%"><tr style="text-align: center;"><td width="90%" style="padding-left: 10%;">.::<?php echo $title;?>::.</td><td width="10%" align="right"><button type="button" onclick="$('#ModalChasisEdit').modal('hide');">x</button></td></tr></table>
                ...
                <div class="modal-content" style="height:170x;">
                    <div class="modal-header">                        
                        <h4 class="modal-title" id="myModalLabel">Data Inventory Kendaraanq</h4>
                    </div>
                ...
                <tbody>
                 ...
                 $j=1;
                        ...
                        <tr>
                          ...
                          <td>
                                        <button type="button" class="btn btn-default btn-circle" onclick="selectChasise('<?php echo $catat['no_chasis'];?>','<?php echo $catat['no_mesin'];?>','<?php echo $catat['no_polisi'];?>','<?php echo $catat['id_warna_kendaraan'];?>','<?php echo $catat['warna'];?>','<?php echo $catat['fk_customer'];?>','<?php echo $catat['nama'];?>');">Pilih</button>
              ...
              <script type="text/javascript">
               ...
               function selectChasise(a,b,c,d,e,f,g){
                              $("#chasise").val(a);
                              $("#mesine").val(b);
                              $("#polisie").val(c);
                              $("#warnae").val(d);
