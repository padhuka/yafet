   ...
   <table width="100%"><tr style="text-align: center;"><td width="90%" style="padding-left: 10%;">.::<?php echo $title;?>::.</td><td width="10%" align="right"><button type="button" data-dismiss="modal">x</button></td></tr></table>
                ...
                <div class="modal-content" style="height:190px;">
                    <div class="modal-header">                        
                        <h4 class="modal-title" id="myModalLabel">Cetak Pembayaran Bank</h4>
                    </div>
                    ...
                    <div class="row">
                                          <div class="col-sm-12">
                                              <h4 class="modal-title" id="myModalLabel">
                                               <a href="bank/bank_cetak.php?nobukti=<?php echo $nobukti;?>" target="blank"><button type="button" class=" btn btn-default btn-circle" name="close" onclick="cetak();">Print</button></a>
                                        <button type="button" class=" btn btn-default btn-circle" name="close" onclick="$('#ModalBankPrint').modal('hide');">Close</button>
                                              </h4>
                                          </div>
                   </div>
        </div>
