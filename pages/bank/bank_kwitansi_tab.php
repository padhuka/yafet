   ...
   ?>
<div id="ModalBankKwitansi" class="modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="title">   
        <table width="100%"><tr style="text-align: center;"><td width="90%" style="padding-left: 10%;">.::<?php echo $title;?>::.</td><td width="10%" align="right"><button type="button" onclick="$('#ModalBankKwitansi').modal('hide');">x</button></td></tr></table>
    </div>
                <div class="modal-content">
                  ...
                  <div class="box">
                <table id="bankkwitansi" class="table table-condensed table-bordered table-striped table-hover dataTable">
                ...
                <?php
                        ...
                        <tr>
                          ...
                          <td >
                                        ...
                                        <button type="button" class="btn btn-default btn-circle" onclick="selectKwitansi('<?php echo $catat['no_kwitansi'];?>','<?php echo ($catat['nilai']-($catat['titip_bank']+$catat['titip_cash']));?>');">Pilih</button>
