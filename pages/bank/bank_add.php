   ...
   <table width="100%"><tr style="text-align: center;"><td width="90%" style="padding-left: 10%;">.::<?php echo $title;?>::.</td><td width="10%" align="right"><button type="button" data-dismiss="modal">x</button></td></tr></table>
               ...
               <tr role="row" class="even">
                 <td class="sorting_1" width="15%">Via Bayar</td>
                  ...
                  <td  width="10%">Partner Bank</td>
                  <td  width="50%">
                    <div id="showPartner">
                      <div class="col-sm-10">
                        <input type="hidden"  class="form-control" id="id_partner_bank" name="id_partner_bank" readonly style="width:100%;">
                        <input type="text"  class="form-control" id="namapartner" name="namapartner" readonly style="width:100%;">
                        </div>
                        <button type="button" class="btn btn-default btn-circle btn-md" onclick="selectPartner();">Pilih</button><input type="hidden" class="form-control" id="tipe" name="tipe" readonly style="width: 10%;">
                    </div>                    
               </tr>
