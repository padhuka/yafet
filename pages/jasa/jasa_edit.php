   ...
   <table width="100%"><tr style="text-align: center;"><td width="90%" style="padding-left: 10%;">.::<?php echo $title;?>::.</td><td width="10%" align="right"><button type="button" data-dismiss="modal">x</button></td></tr></table>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
				            <form class="form-horizontal" enctype="multipart/form-data" novalidate id="formjasaEdit">
                ...
                <tr role="row" class="odd">
                  ...
                  <td width="30%"> <input type="text" class="form-control" id="id_jasa" name="id_jasa" value="<?php echo $emp['id_jasa'];?>" required  readonly></td>
               ...
               <tr role="row" class="even">
                ...
                <tr><td colspan="4">&nbsp;</td></tr>
                 <tr><td colspan="4" align="center" class="bgsave"><button type="submit" class=" btn btn-default btn-circle save_submit" name="Submit" value="SIMPAN">Simpan</button>
                            	...
                            	<input type="hidden" name="id_jasahid" id="id_jasahid" value="<?php echo $emp['id_jasa'];?>">
...
<script type="text/javascript">
	$(document).ready(function (){
                      ...
                      $("#formjasaEdit").on('submit', function(e){
                          e.preventDefault();
                           						$.ajax({
                                                  type: 'POST',
                                                  url: 'jasa/jasa_edit_save.php',
