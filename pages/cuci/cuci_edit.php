   ...
   <table width="100%"><tr style="text-align: center;"><td width="90%" style="padding-left: 10%;">.::<?php echo $title;?>::.</td><td width="10%" align="right"><button type="button" data-dismiss="modal">x</button></td></tr></table>
                ...
                <div class="modal-content">
                    <div class="modal-header">                        
                        <h4 class="modal-title" id="myModalLabel">Edit Data Cuci Mobil</h4>
                    </div>
                    ...
                    <div class="modal-body">
				            <form class="form-horizontal" enctype="multipart/form-data" novalidate id="formcuciEdit">
                ...
                <tr role="row" class="odd">
                  <td class="sorting_1" width="20%">Kode Cuci Mobil</td>
                  <td width="30%"> <input type="text" class="form-control" id="id_cuci" name="id_cuci" value="<?php echo $emp['id_cuci'];?>" required  readonly></td>
