      ...
      <table id="group1" class="table table-condensed table-bordered table-striped table-hover">
                ...
                <?php
                        ...
                        <tr>
                          ...
                          <td >
                                        <button type="button" class="btn btn-default btn-circle" id="<?php echo $catat['id_group_kendaraan']; ?>" onclick="open_modal(ideditgroup='<?php echo $catat['id_group_kendaraan']; ?>');"><span>Edit</span></button>
                                         <button type="button" class="btn btn-default btn-circle" id="<?php echo $catat['id_group_kendaraan']; ?>" onclick="open_del(iddelgroup='<?php echo $catat['id_group_kendaraan']; ?>');"><span>Hapus</span></button>
