   ...
   <table width="100%"><tr style="text-align: center;"><td width="90%" style="padding-left: 10%;">.::<?php echo $title;?>::.</td><td width="10%" align="right"><button type="button" data-dismiss="modal">x</button></td></tr></table>
                ...
                <tr role="row" class="odd">
                  ...
                  <td  width="50%">
                    ...
                    <div id="showpkb_jasa"><div class="col-sm-10">
                      <input type="text"  class="form-control" id="idpkb_jasa" name="idpkb_jasa" readonly style="width:100%;">
                      </div>
                      <button type="button" class=" btn btn-default btn-circle btn-md" onclick="selectpkb_jasa();">Pilih</button><input type="hidden" class="form-control" id="tipe" name="tipe" readonly style="width: 10%;">
                    </div>
                  </td>
                  <td  width="50%"></td>
                  </td>
