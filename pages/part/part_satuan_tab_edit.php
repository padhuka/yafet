      <div id="ModalSatuanEdit" class="modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
   ...
   <table width="100%"><tr style="text-align: center;"><td width="90%" style="padding-left: 10%;">.::<?php echo $title;?>::.</td><td width="10%" align="right"><button type="button" onclick="keluar();" >x</button></td></tr></table>
      ...
      <div class="col-md-14">
                <div class="modal-content">
                  ...
                  <div class="box">
              <table id="satuanedit" class="table table-condensed table-bordered table-striped table-hover">
              ...
              function keluar(){
                  $("#ModalSatuanEdit").modal('hide');
                }
                $('#satuanedit').DataTable();
                function pilih(x,y){
                              $("#satuan").val(x);
                              $("#satuannm").val(y);
                              $("#ModalSatuanEdit").modal('hide');
