   ...
   ?>
     <div id="ModalCashpkb_jasa" class="modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
<div class="modal-dialog">
  <div class="title">   
   <table width="100%"><tr style="text-align: center;"><td width="90%" style="padding-left: 10%;">.::<?php echo $title;?>::.</td><td width="10%" align="right"><button type="button" onclick="$('#ModalCashpkb_jasa').modal('hide');">x</button></td></tr></table>
  </div>
                <div class="modal-content">
                  ...
                  <div class="box">
                <table id="cashpkb_jasa" class="table table-condensed table-bordered table-striped table-hover">
              ...
              <script type="text/javascript">
                $('#cashpkb_jasa').DataTable();

               function selectpkb_jasa(a){
                              $("#idpkb_jasa").val(a);
                              $("#ModalCashpkb_jasa").modal('hide');
