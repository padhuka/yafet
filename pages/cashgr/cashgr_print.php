<!-- general form elements disabled -->
   <?php
    ...
    $sqlcatat = "SELECT * FROM t_cashgr WHERE no_bukti='$nobukti'";
   ...
   <table width="100%"><tr style="text-align: center;"><td width="90%" style="padding-left: 10%;">.::<?php echo $title;?>::.</td><td width="10%" align="right"><button type="button" data-dismiss="modal">x</button></td></tr></table>
                ...
                <div class="modal-content">
                    <div class="modal-header">                        
                        <h4 class="modal-title" id="myModalLabel">Cetak Data cashgr</h4>
                    </div>
                    ...
                    <div class="row">
                                          <div class="col-sm-12">
                                              ...
                                              <a href="cashgr/cashgr_cetak.php?nobukti=<?php echo $nobukti;?>" target="blank"><button type="button" class=" btn btn-default btn-circle" name="close" onclick="cetak();">Print</button></a>
                                    <button type="button" class=" btn btn-default btn-circle" name="close" onclick="$('#ModalcashgrPrint').modal('hide');">Close</button>
                                              </h4>
                                          </div>
                                        </div>
                                    </form>
