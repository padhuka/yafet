<?php
    ...
    $id = $_GET['nobukti'];
    $sqlemp = "SELECT * FROM t_cashgr WHERE no_bukti='$id'";
   ...
   <table width="100%"><tr style="text-align: center;"><td width="90%" style="padding-left: 10%;">.::<?php echo $title;?>::.</td><td width="10%" align="right"><button type="button" data-dismiss="modal">x</button></td></tr></table>
               ...
               <div class="modal-content" style="height:190px;">
                    <div class="modal-header">                        
                        <h4 class="modal-title" id="myModalLabel">Batal Penerimaan Cash GR</h4>
                    </div>
                    <br>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <form class="form-horizontal" enctype="multipart/form-data" novalidate id="formcashgr">
                                        <div class="alert alert-danger">Apakah anda yakin ingin membatalkan Perimaan cashgr ( <?php echo $id;?>) ?</div>
                ...
                <script type="text/javascript">
                  $(document).ready(function (){
                        $(".save_submit").click(function (e){
                           ...
                           $.ajax({
                                url: 'cashgr/cashgr_del_save.php?no_bukti=<?php echo $id;?>&keteranganbatal='+keteranganbatal,
                                type: 'GET',
