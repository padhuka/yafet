  ...
  <div class="content-wrapper">
    ...
    Data Paket Jasa
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Data Paket Jasa</li>
      </ol>
    </section>
    ...
    <!-- /.content -->
        ...
        <div id="ModalAdd" class="modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
         ...
         <div id="ModalPaketjasaDet" class="modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
