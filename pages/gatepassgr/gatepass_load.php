      ...
      <table id="gatepass" class="table table-condensed table-bordered table-striped table-hover">
                ...
                <?php
                                    $j=1;
                                    $sqlcatat = "SELECT * FROM t_gate_passgr 
                        ...
                        <tr>
                          ...
                          <td ><?php echo $catat['fk_pkb_jasa'];?></td>
           ...
           function open_add(){
              $.ajax({
                    url: "gatepassgr/gatepass_add.php",
                    type: "GET",
           ...
           function open_del(x){
                                $.ajax({
                                    url: "gatepassgr/gatepass_del.php?nogatepass="+x,
                                    type: "GET",
                                    success: function (ajaxData){
            ...
            function open_gatepass(z){
                              $.ajax({
                                  url: "gatepassgr/gatepass_show.php?nogatepass="+z,
                                  type: "GET",
                                  success: function (ajaxData){
            ...
            function cetak_get(q){
                              $.ajax({
                                  url: "gatepassgr/gatepass_print.php?nogatepass="+q,
                                  type: "GET",
                                  success: function (ajaxData){
