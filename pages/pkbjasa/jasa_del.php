...
<div class="modal-dialog">
            <div class="title">   
   <table width="100%"><tr style="text-align: center;"><td width="90%" style="padding-left: 10%;">.::<?php echo $title;?>::.</td><td width="10%" align="right"><button type="button" onclick="$('#ModalDeletejasa').hide();$('#ModalAddjasax').modal('hide');">x</button></td></tr></table>
  </div>
                    ...
                    <div class="modal-header">                        
                        ...
                        <div class="col-lg-12">    
                                   ...
                                   <h4 class="modal-title" id="myModalLabel">
                                            ...
                                            <button type="button" class=" btn btn-default btn-circle"  onclick="$('#ModalDeletejasa').hide();$('#ModalAddjasax').modal('hide');" aria-hid_jasa="true">&nbsp;Batal&nbsp;</button>
                                        </h4>
                                    </form>
                                </div>
                            </div>
                ...
                <script type="text/javascript">
                  $(document).ready(function (){
                        $(".save_submit").click(function (e){
                            ...
                            //return false;
                                $.ajax({
                                   url: 'pkbjasa/jasa_del_save.php?id=<?php echo $id;?>&idpkbjasa=<?php echo $idpkbjasa;?>',
                                    type: 'GET',
