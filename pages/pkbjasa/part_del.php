<?php
    ...
    //echo $sqlemp;
    $nmjasa="SELECT * FROM t_part WHERE id_part='$emp[fk_jasa]'";
    $hjasa=mysql_fetch_array(mysql_query($nmjasa));
?>
<div class="modal-dialog">
            <div class="title">   
   <table width="100%"><tr style="text-align: center;"><td width="90%" style="padding-left: 10%;">.::<?php echo $title;?>::.</td><td width="10%" align="right"><button type="button" onclick="$('#ModalDeletepart').hide();$('#ModalAddparty').modal('hide');">x</button></td></tr></table>
  </div>
                    ...
                    <div class="modal-header">                        
                        ...
                        <div class="col-lg-12">    
                                   ...
                                   <h4 class="modal-title" id="myModalLabel">
                                             <input type="hidden" id="id_part" name="id_part" value="<?php echo $id;?>">
                                            <button type="button" class=" btn btn-default btn-circle save_submit" name="Submit" value="SIMPAN">&nbsp;&nbsp;&nbsp;Ya&nbsp;&nbsp;&nbsp;</button>
                                            <button type="button" class=" btn btn-default btn-circle"  onclick="$('#ModalDeletepart').hide();$('#ModalAddparty').modal('hide');" aria-hid_jasa="true">&nbsp;Batal&nbsp;</button>
                                        </h4>
                                    </form>
                                </div>
                            </div>
