  ...
  <div class="content-wrapper">
    ...
    Data PKB Jasa
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Data PKB Generail Repair</li>
      </ol>
    </section>
    ...
    <!-- /.content -->
        ...
        <div id="ModalShow" class="modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
         ...
         <div id="ModalpkbjasaDet" class="modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
         <div id="ModalEstPrint" class="modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
         <div id="ModalApproved" class="modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
