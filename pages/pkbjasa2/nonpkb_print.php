           ...
           <div class="modal-content">
                ...
                <?php
                    ...
                    <?php }?>
                      ...
                      <div class="but"><a href="nonpkb/nonpkb_cetak.php?idnonpkb=<?php echo $idnonpkb;?>" target="blank"><button type="button" class=" btn btn-default btn-circle" name="close" onclick="cetak();">Print</button></a>
