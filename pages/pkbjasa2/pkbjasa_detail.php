<!-- general form elements disabled -->
   <?php
    ...
    $sqles = "SELECT * FROM t_pkb_jasa WHERE id_pkb_jasa='$idpkbjasa[0]'";
   ...
   <table width="100%"><tr style="text-align: center;"><td width="90%" style="padding-left: 10%;">.::<?php echo $title;?>::.</td><td width="10%" align="right"><button type="button" data-dismiss="modal">x</button></td></tr></table>
                ...
                <div class="modal-content">
                    <div class="modal-header">                        
                        <h4 class="modal-title" id="myModalLabel">Data PKB Jasa</h4>
                    </div>
                ...
                <div class="modal-header">                        
                        <h4 class="modal-title" id="myModalLabel">
                                    <button type="button" class=" btn btn-default btn-circle" name="jasa" onclick="jasae('<?php echo $idpkbjasa[0];?>'); $('#ModalAddjasax').modal('show');">&nbsp;Jasa&nbsp;</button>
        ...
        <script type="text/javascript">
            $(document).ready(function (){
                 var idpkbjasae='<?php echo $idpkbjasa[0];?>';
