   ...
   <table width="100%"><tr style="text-align: center;"><td width="90%" style="padding-left: 10%;">.::<?php echo $title;?>::.</td><td width="10%" align="right"><button type="button" data-dismiss="modal">x</button></td></tr></table>
                ...
                <div class="modal-content" style="height:200px;">
                    <div class="modal-header">                        
                        <h4 class="modal-title" id="myModalLabel">Cetak Pembayaran Payment Non PKB</h4>
                    </div>
                    ...
                    <div class="modal-header">                        
                        <h4 class="modal-title" id="myModalLabel"> <a href="paycuci/paycuci_cetak.php?nobukti=<?php echo $nobukti;?>" target="blank"><button type="button" class=" btn btn-default btn-circle" name="close" onclick="cetak();">Print</button></a>
                                    <button type="button" class=" btn btn-default btn-circle" name="close" onclick="$('#ModalpaycuciPrint').modal('hide');">Close</button></h4>
                    </div>
